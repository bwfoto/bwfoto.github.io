...
$(function () {
  ...
  $('.and-txt').each(function () {
    var ths = $(this);
    ths.html(ths.html().replace('and', '<span><a href="/">and</a></span>'));
  });
...
$(function () {
  ...
  $('.logoswg').each(function () {
    var bwf = $(this);
    bwf.html(bwf.html().replace('bwfoto', '<a href="/">bw &#160<img src="images/bwfoto.svg" alt"Черно-белая фотография">foto</a>'));
  });
...
$(function () {
  ...
  $('#my-menu').mmenu({
    extensions: [ 'theme-light', 'shadow-page', 'fx-menu-slide', 'fx-listitems-slide', 'pagedim-black', 'position-back', 'position-right'],
    navbar: {
      title: '<div class="mm-navbar_logo">bw &#160<img src="images/bwfoto.svg" alt"Черно-белая фотография">foto</div>'
    },
  });
